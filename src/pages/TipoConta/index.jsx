      ...
      <div className={styles.container}>
        <div className={styles.n1}>
          ...
          <div className={styles.formlog}>
            ...
            <div className={styles.divccorrente}>
              <input className={styles.inputform1} type="radio" id="conta-corrente" name="account-type" value="conta-corrente" checked={selectedOption === 'conta-corrente'} onChange={handleOptionChange} />
              <label className={styles.nome} htmlFor="conta-corrente">Conta Corrente</label>
            </div>

            <div className={styles.divcpoupanca}>
              <input className={styles.inputform2} type="radio" id="conta-poupanca" name="account-type" value="conta-poupanca" checked={selectedOption === 'conta-poupanca'} onChange={handleOptionChange} />
          ...
          <div className={styles.divbtn}>
            <Link className={styles.linkbtn} to="/Cadastro/5">
